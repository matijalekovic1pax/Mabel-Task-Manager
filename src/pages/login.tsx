...
export function LoginPage() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // In real OAuth, the browser redirects to Google at this point.
      ...
      <Card className="w-full max-w-md border-0 shadow-xl shadow-violet-100/50">
        ...
        <CardContent className="pt-4 space-y-3">
          ...
          <Button
            ...
            disabled={signingIn}
            className="w-full bg-gradient-to-r from-violet-500 to-indigo-600 hover:from-violet-600 hover:to-indigo-700 shadow-md shadow-violet-200 transition-all hover:shadow-lg"
            size="lg"
          >
            {signingIn ? (
